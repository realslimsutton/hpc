...
class UserResource extends Resource
{
    ...
    protected static ?string $slug = 'system/members';
                    ...
                    ->schema([
                        Forms\Components\Tabs::make('User')
                            ...
                            ->schema([
                                ...
                                Forms\Components\Tabs\Tab::make('Promotions')
                                    ->schema([
                                        Forms\Components\Fieldset::make('Loyalty Program')
                                            ->schema([
                                                Forms\Components\Select::make('loyalty_tier_id')
                                                    ->label('Loyalty Tier')
                                                    ->relationship('loyalty_tier', 'name')
                                                    ->preload()
                                                    ->searchable()
                                                    ->nullable()
                                                    ->helperText('Leave blank for unranked members'),
                                            ]),
                                    ]),
                            ]),
                    ]),
                        ...
                        Forms\Components\Card::make()
                            ->schema([
                                Forms\Components\Placeholder::make('balance')
                                    ->label('Balance')
                                    ->content(static fn(?User $record): string => Money::USD($record?->balance ?? 0)),
                                Forms\Components\Placeholder::make('nickname')
                                    ->label('Nickname')
                                    ->content(static fn(?User $record): string => $record?->nickname ?? '-'),
